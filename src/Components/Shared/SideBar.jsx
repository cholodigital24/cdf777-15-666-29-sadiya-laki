...
const profile = "https://i.ibb.co/fDwVHZJ/profile.jpg";
const Menus = [
  // Biography
  {
    title: "Home",
...
const SocialLinks = [
  {
    ...
    to: "https://web.facebook.com/sadia.lucky.10",
  },
  // {
  //   title: "Twitter",
  //   icons: <FaTwitter className="text-white" />,
  //   to: "https://twitter.com/mim_bidya?lang=en", // Replace with your actual link
  // },
  {
    title: "Instagram",
    icons: <FaInstagram className="text-white" />,
    to: "https://www.instagram.com/sadia00128?igsh=cnB5cGNyeDdlN3Mw", // Replace with your actual link
  },
  // {
  //   title: "TikTok",
  //   icons: <FaTiktok className="text-white" />,
  //   to: "https://www.tiktok.com/@bidyasinhasahamim?lang=en", // Replace with your actual link
  // },
  // {
  //   title: "YouTube",
  //   icons: <FaYoutube className="text-white" />,
  //   to: "https://youtube.com/@BidyaSinhaMim?si=glFJGcEK7QsEb4LJ", // Replace with your actual link
  // },
];
